...
# if this is performant then I understand nothing about branch prediction
class SGharePred(Predictor):
    ...
    def update(self, addr : int, pred : int, result : bool):
        ...
        patReg.put(result)
        # AND DO WEIRD, WEIRD STUFF TO THE GHR
        newghr = ((1 << (self.ghr.read())) & (2**self.ind_bits - 1)) | result
        self.ghr.value = newghr  # WHAT IN THE WORLD
